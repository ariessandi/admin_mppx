                                    ...
                                    <table class="table product-overview" id="zero_config">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>Steave Jobs</td>
                                                <td>#85457898</td>
                                                <td> <img src="<?php echo base_url();?>/assets/mpro/material_files/chair.jpg" alt="iMac"
                                                        width="80"> </td>
                                                <td>Rounded Chair</td>
                                                <td>20</td>
                                                <td>10-7-2017</td>
                                            ...
                                            <tr>
                                                <td>Varun Dhavan</td>
                                                <td>#95457898</td>
                                                <td> <img src="<?php echo base_url();?>/assets/mpro/material_files/chair2.jpg" alt="iPhone"
                                                        width="80"> </td>
                                                <td>Wooden Chair</td>
                                                <td>25</td>
                                                <td>09-7-2017</td>
                                            ...
                                            <tr>
                                                <td>Ritesh Desh</td>
                                                <td>#68457898</td>
                                                <td> <img src="<?php echo base_url();?>/assets/mpro/material_files/chair3.jpg" alt="apple_watch"
                                                        width="80"> </td>
                                                <td>Gray Chair</td>
                                                <td>12</td>
                                                <td>08-7-2017</td>
                                            ...
                                            <tr>
                                                <td>Hrithik</td>
                                                <td>#45457898</td>
                                                <td> <img src="<?php echo base_url();?>/assets/mpro/material_files/chair4.jpg" alt="mac_mouse"
                                                        width="80"> </td>
