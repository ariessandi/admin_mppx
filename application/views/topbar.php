                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html">
                        ...
                        <b class="logo-icon">
                            ...
                            <!-- Dark Logo icon -->
                            <img src="<?php echo base_url();?>/assets/mpro/material_files/logo-icon.png" alt="homepage" class="dark-logo" />
                            <!-- Light Logo icon -->
                            <img src="<?php echo base_url();?>/assets/mpro/material_files/logo-light-icon.png" alt="homepage" class="light-logo" />
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <span class="logo-text">
                            <!-- dark Logo text -->
                            <img src="<?php echo base_url();?>/assets/mpro/material_files/logo-text.png" alt="homepage" class="dark-logo" />
                            <!-- Light Logo text -->
                            <img src="<?php echo base_url();?>/assets/mpro/material_files/logo-light-text.png" class="light-logo" alt="homepage" />
                        </span>
                    </a>
                    <!-- =============================== -->
                    <!-- End Logo -->
                                            ...
                                            <div class="carousel-inner" role="listbox">
                                                <div class="carousel-item active">
                                                    <div class="container"> <img class="d-block img-fluid"
                                                            src="<?php echo base_url();?>/assets/mpro/material_files/big/img1.jpg" alt="First slide"></div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container"><img class="d-block img-fluid"
                                                            src="<?php echo base_url();?>/assets/mpro/material_files/big/img2.jpg" alt="Second slide">
                                                    </div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container"><img class="d-block img-fluid"
                                                            src="<?php echo base_url();?>/assets/mpro/material_files/big/img3.jpg" alt="Third slide"></div>
                                                </div>
                                            </div>
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark" href="" data-toggle="dropdown"
                                ...
                                <img src="<?php echo base_url();?>/assets/mpro/material_files/1.jpg" alt="user" width="30" class="profile-pic rounded-circle" />
                            </a>
                            <div class="dropdown-menu mailbox dropdown-menu-right scale-up">
                                <ul class="dropdown-user list-style-none">
                                    <li>
                                        <div class="dw-user-box p-3 d-flex">
                                            <div class="u-img"><img src="<?php echo base_url();?>/assets/mpro/material_files/1.jpg" alt="user" class="rounded" width="80"></div>
                                            <div class="u-text ml-2">
                                                <h4 class="mb-0">Steave Jobs</h4>
                                                <p class="text-muted mb-1 font-14"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="a5d3c4d7d0cbe5c2c8c4ccc98bc6cac8">[email&#160;protected]</a></p>
