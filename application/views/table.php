                            ...
                            <table id="zero_config" class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><img width="200" src="https://awsimages.detik.net.id/community/media/visual/2020/10/07/dalton-ichiro_169.jpeg?w=700&q=90" alt=""></td>
                                        <td>Veritatis necessitatibus autem expedita  sit qui...</td>
                                        <td>
                                            <span class="badge badge-pill badge-success">Published</span>
                                        </td>
                                        <td>
                                            <a href="#" class="btn btn-rounded btn-danger" id="sa-confirm" data-toggle="tooltip" data-placement="top" title="Delete"><span><i class="ti-trash"></i></span></a>  
                                            <a href="#" class="btn btn-rounded btn-info" data-toggle="tooltip" data-placement="top" title="Edit"><span><i class="ti-pencil-alt"></i></a>
                                        </td>
                                    </tr>
